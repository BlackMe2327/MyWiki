...
![image-20220204134928986](https://github.com/BlackMe2327/cloudimages27/blob/main/img/image-20220204134928986.png?raw=true)

其中包含3个nacos节点，然后一个负载均衡器代理3个Nacos。这里负载均衡器可以使用nginx。

### 使用Nginx做负载均衡器后的Nacos集群图

![image-20220204135141189](https://github.com/BlackMe2327/cloudimages27/blob/main/img/image-20220204135141189.png?raw=true)
...
![image-20220204135924832](https://github.com/BlackMe2327/cloudimages27/blob/main/img/image-20220204135924832.png?raw=true)

### 配置Nacos

#### 在nacos的conf目录：

将cluster.conf.example，重命名为cluster.conf然后添加内容
...
修改nginx的conf/nginx.conf文件，配置如下：
...
nacos1、nacos2、nacos3均需修改nacos的bin目录下的start.cmd文件

![image-20220204225949478](https://github.com/BlackMe2327/cloudimages27/blob/main/img/image-20220204225949478.png?raw=true)
...
如果出现浏览器可以访问nacos控制页面，但本地服务无法注册的问题，如下问题：
...
是因为在配置的时候还需要配置上spring.cloud.nacos.`discovery`.server-addr=xxx.xxx.xxx.xxx:80
